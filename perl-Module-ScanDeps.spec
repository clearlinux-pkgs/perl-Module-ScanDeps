...
Source0  : https://cpan.metacpan.org/authors/id/R/RS/RSCHUPP/Module-ScanDeps-1.29.tar.gz
...
%prep
%setup -q -n Module-ScanDeps-1.29
cd %{_builddir}/Module-ScanDeps-1.29
...
cp %{_builddir}/Module-ScanDeps-1.29/LICENSE %{buildroot}/usr/share/package-licenses/perl-Module-ScanDeps/724e019aadc4cc1b851dc94c40ca66972aaaaaed
if test -f Makefile.PL; then
...
%files perl
%defattr(-,root,root,-)
/usr/lib/perl5/vendor_perl/5.30.3/Module/ScanDeps.pm
/usr/lib/perl5/vendor_perl/5.30.3/Module/ScanDeps/Cache.pm
