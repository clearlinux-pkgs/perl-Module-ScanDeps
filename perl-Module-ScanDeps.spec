...
Source0  : https://cpan.metacpan.org/authors/id/R/RS/RSCHUPP/Module-ScanDeps-1.28.tar.gz
...
%prep
%setup -q -n Module-ScanDeps-1.28
cd %{_builddir}/Module-ScanDeps-1.28
...
cp %{_builddir}/Module-ScanDeps-1.28/LICENSE %{buildroot}/usr/share/package-licenses/perl-Module-ScanDeps/724e019aadc4cc1b851dc94c40ca66972aaaaaed
if test -f Makefile.PL; then
