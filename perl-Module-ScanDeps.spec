...
Source0  : https://cpan.metacpan.org/authors/id/R/RS/RSCHUPP/Module-ScanDeps-1.37.tar.gz
...
%prep
%setup -q -n Module-ScanDeps-1.37
cd %{_builddir}/Module-ScanDeps-1.37
pushd ..
cp -a Module-ScanDeps-1.37 buildavx2
popd
