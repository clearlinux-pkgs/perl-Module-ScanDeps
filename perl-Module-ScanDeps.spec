...
Version  : 1.30
Release  : 31
URL      : https://cpan.metacpan.org/authors/id/R/RS/RSCHUPP/Module-ScanDeps-1.30.tar.gz
Source0  : https://cpan.metacpan.org/authors/id/R/RS/RSCHUPP/Module-ScanDeps-1.30.tar.gz
...
%prep
%setup -q -n Module-ScanDeps-1.30
cd %{_builddir}/Module-ScanDeps-1.30
...
cp %{_builddir}/Module-ScanDeps-1.30/LICENSE %{buildroot}/usr/share/package-licenses/perl-Module-ScanDeps/724e019aadc4cc1b851dc94c40ca66972aaaaaed
if test -f Makefile.PL; then
